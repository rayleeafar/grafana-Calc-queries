System.register(['./datasource', './query_ctrl', './config_ctrl'], function(exports_1) {
    ...
    return {
        ...
        execute: function() {
            exports_1("Datasource", datasource_1.CalcQueriesDatasource);
            exports_1("QueryCtrl", query_ctrl_1.CalcQueriesQueryCtrl);
            exports_1("ConfigCtrl", config_ctrl_1.CalcQueriesConfigCtrl);
        }
    }
});
